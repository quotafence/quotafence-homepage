...
for (const token of ["quotafence", "qfence top --once", "PROJECT ALLOCATIONS", "refreshed just now", "qfence allocations add", "qfence codex", "qfence claude", "Claude Code", "GitHub Copilot", "Soon", "Read the docs", "data-menu-button", "data-cli-tab", "Allocations", "Daily usage"]) {
