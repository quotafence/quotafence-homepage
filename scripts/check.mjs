...
for (const token of ["quotafence", "qfence top --once", "PROJECT ALLOCATIONS", "refreshed just now", "qfence allocations add", "qfence codex", "qfence claude", "Claude Code", "GitHub Copilot", "Coming soon", "Read the docs", "data-menu-button", "data-cli-tab", "Allocations", "2 allowance windows"]) {
