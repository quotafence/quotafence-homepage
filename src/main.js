  ...
  <main id="top">
    <section class="hero section-shell">
      <div class="hero-copy reveal">
        ...
        <p class="hero-lead">QuotaFence tracks Codex and Claude Code allowances, assigns weekly budgets to local folders, and helps prevent lower-priority work from consuming quota intended for critical projects.</p>
...
❯ qfence admit codex</pre></div>
    ...
    <section class="faq-section section-shell" id="faq">
      ...
      <div class="faq-list reveal">
        <details><summary>What is QuotaFence?</summary><p>QuotaFence is an open-source, local-first quota manager for Codex and Claude Code. It tracks provider allowance windows and lets you assign weekly budgets and priorities to local project folders.</p></details>
